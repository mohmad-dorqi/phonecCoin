...
const Boost = () => {
  ...
  const [isUpgradeModalVisibleEnc, setIsUpgradeModalVisibleEnc] = useState(
    false
  );
  ...
  const handleEnergyUpgrade = async () => {
    ...
    if (
      ...
      try {
        ...
        console.log(
          "Energy value upgraded successfully +",
          newEnergyValue.value
        );
  ...
  const handlerRechargeUpgrade = async () => {
    ...
    if (
      nextChargingLevel < chargingValues.length &&
      balance + refBonus >= chargingUpgradeCost &&
      id
    ) {
            ...
            <div className="w-full flex flex-col">
              ...
              <div className="w-full flex justify-between items-center">
                ...
                <button
                  ...
                  } bg-cards w-[48%] border-[1px] border-borders rounded-[8px] p-[8px] flex space-x-1`}
                >
                  ...
                  <div className="flex flex-1 flex-col text-left">
                    <span className="font-semibold tapguru">Tapping Guru</span>
                    {freeGuru > 0 ? (
                ...
                <button
                  ...
                  className={`${
                    fullTank > 0 ? "opacity-100" : "opacity-[.5]"
                  } bg-cards w-[48%] border-[1px] border-borders rounded-[8px] p-[8px] flex`}
                >
                  <div className="w-[40px] flex items-center justify-center">
                    <img
                      src={flash}
              ...
              <button
                ...
                className={`${
                  tapValue.level >= tapValues.length
                    ? "opacity-[.7]"
                    : "opacity-100"
                } bg-cards rounded-[10px] px-[14px] py-[8px] flex justify-between items-center`}
              >
          ...
          >
            <div className="w-full flex flex-col justify-between py-8">
              ...
              <div className="w-full flex justify-center flex-col items-center">
                ...
                <h3 className="font-semibold text-[32px] py-4">Multitap</h3>
                ...
                <div className="flex flex-1 items-center space-x-2">
                  ...
                  <div className="font-bold text-[26px] flex items-center">
                    {formatNumber(nextUpgradeCost)}{" "}
                    <span className="text-[16px] font-medium text-[#9a96a6] pl-2">
                      {" "}
                      | {tapValues[tapValue.level]?.value} level
                    </span>
                  </div>
                </div>
              </div>
                ...
                <button
                  ...
                  className={`${
                    !hasSufficientBalance
                      ? "bg-btn2 text-[#979797]"
                      : "bg-gradient-to-b gradient from-[#ffba4c] to-[#aa6900]"
          ...
          >
            <div className="w-full flex flex-col justify-between py-8">
              ...
              <div className="w-full flex justify-center flex-col items-center">
                ...
                <h3 className="font-semibold text-[32px] py-4">Energy Limit</h3>
                <p className="pb-6 text-[#9a96a6] text-[16px] text-center">
                ...
                <div className="flex flex-1 items-center space-x-2">
                  ...
                  <div className="font-bold text-[26px] flex items-center">
                    ...
                    <span className="text-[16px] font-medium text-[#9a96a6] pl-2">
                      {" "}
                      | {energyValues[battery.level]?.level} level
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div className="w-full flex justify-center flex-col items-center">
                ...
                <div className="flex flex-1 items-center space-x-2">
                  ...
                  <div className="font-bold text-[26px] flex items-center">
                    ...
                    <span className="text-[16px] font-medium text-[#9a96a6] pl-2">
                      {" "}
                      | {chargingValues[timeRefill.level]?.level} level
                    </span>
                  </div>
                </div>
              </div>
          ...
          >
            <div className="w-full flex flex-col justify-between py-8">
              ...
              <div className="w-full flex justify-center flex-col items-center">
                ...
                <h3 className="font-semibold text-[32px] py-4">Tapping Guru</h3>
                <p className="pb-6 text-[#9a96a6] text-[16px] text-center">
                  Multiply your tap income by x5 for 20 seconds. Do not use
                  energy while active.
                </p>
          ...
          >
            <div className="w-full flex flex-col justify-between py-8">
              ...
              <div className="w-full flex justify-center flex-col items-center">
                ...
                <h3 className="font-semibold text-[32px] py-4">Full Tank</h3>
                <p className="pb-6 text-[#9a96a6] text-[16px] text-center">
          ...
          >
            <div className="w-full flex flex-col justify-between py-8">
              ...
              <div className="w-full flex justify-center flex-col items-center">
                ...
                <h3 className="font-semibold text-[32px] py-4">Tap Bot</h3>
                <p className="pb-6 text-[#9a96a6] text-[16px] text-center">
